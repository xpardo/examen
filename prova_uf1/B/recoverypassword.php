...
if($_REQUEST["suma"]!=$_SESSION["suma"]){
    die("la suma no és correcta ");
}
...
if(userExists($_REQUEST["email"])){
    ...
    $mail->Username = 'xpullodsmx@gmail.com';

    //Password to use for SMTP authentication
    $mail->Password = 'unwdeqcjmsmgkuwj';

    //Set who the message is to be sent from
    $mail->setFrom('xpullodsmx@gmail.com', 'Password recovery from my web');
